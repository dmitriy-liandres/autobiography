...
public abstract class ShiroWebModule extends ShiroModule {
    ...
    public ShiroWebModule(Provider<ServletContext> servletContextProvider) {
    ...
    protected final void configureShiro() {
        ...
        bind(Key.get(ServletContext.class, Names.named(NAME))).toProvider(this.servletContextProvider);
