...
public class RenderCommand extends ConfiguredCommand<AutobiographyConfiguration> {
    ...
    @Override
    protected void run(Bootstrap<AutobiographyConfiguration> bootstrap,
                       Namespace namespace,
                       AutobiographyConfiguration configuration) throws Exception {
